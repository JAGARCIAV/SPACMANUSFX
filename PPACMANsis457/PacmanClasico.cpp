...
#include <stdio.h>
//#include "Pacman.h"
PacmanClasico::PacmanClasico(Tile* _tile, Texture* _texturaPacmanClasico, int _posicionX, int _posicionY, int _velocidadPatron) :
	Pacman(_tile,_texturaPacmanClasico, _posicionX, _posicionY,_velocidadPatron)
{
	...
	if (tileActual != nullptr) {
		tileActual->setPacmanClasico(this);
...
void PacmanClasico::setTile(Tile* _tileNuevo) {
	...
	if (tileActual != nullptr) {
		tileActual->setPacmanClasico(nullptr);
	}
